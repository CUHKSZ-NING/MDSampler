# MDSampler: Meta-Distribution-Based Ensemble Sampler for Imbalanced Semi-Supervised Learning
...
![](Time.png)
**Figure 3.** Training time and AUPRC scores of algorithms on [Credit Card Fraud](https://www.google.com) dataset \cite{dal2017credit} with supervision ratio $\beta = 0.1$.
